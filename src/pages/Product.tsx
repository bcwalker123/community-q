      ...
      <div className="container" style={{ paddingTop: 28 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16 }}>
          <div style={{ maxWidth: 720 }}>
            ...
            <FeatureModule title="AI Q&A (RAG-ready)" body="Ask plain-language questions. We retrieve supporting evidence and synthesize a concise answer with a confidence score.">
              <div style={{ marginTop: 10 }}>
                <div style={{ background: 'rgba(2,6,23,0.03)', padding: 12, borderRadius: 8 }}>
                  <strong>Example</strong>
                  <div style={{ color: 'var(--muted)', marginTop: 6 }}>Q: "Top feature requests in #product last 30 days?"</div>
                </div>
              </div>
            </FeatureModule>

            <FeatureModule title="Topic detection & trends" body="Automatic clustering and trending topics help you prioritize what matters most." >
              <div style={{ marginTop: 10 }}>
            ...
            <FeatureModule title="Evidence & provenance" body="Every AI claim is supported by exact post excerpts, timestamps and links to origin so you can verify quickly." />

            <FeatureModule title="Action cards & integrations" body="Create tickets, run polls, and notify channels directly from insights." />
          </div>
